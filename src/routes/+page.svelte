...
>
    ...
    <!-- Heading -->
    <h1
        class="relative max-w-4xl bg-gradient-to-br from-foreground via-foreground/90 to-foreground/70 bg-clip-text text-center text-5xl font-bold tracking-tight text-transparent sm:text-6xl md:text-7xl lg:text-8xl"
    >
        Describe Your <span class="font-serif italic font-light text-foreground"
            >Life.</span
        >
        <br />
        <span class="relative inline-block">
            <span
                class="absolute -inset-1 rounded-lg bg-primary/10 blur-xl opacity-50"
            ></span>
            <span class="relative text-primary inline-flex items-center gap-2"
                >Find Your Home.</span
            >
        </span>
    </h1>
    ...
    <p class="relative mt-6 max-w-xl text-center text-lg text-muted-foreground">
        No more filters. No more guessing. Just tell us how you live, and we'll
        find the apartment that fits.
    </p>
